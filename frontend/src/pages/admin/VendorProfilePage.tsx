...
const fields: Field[] = [
  { key: "name", label: "厂商全称" }, { key: "shortName", label: "厂商简称" },
  ...
  { key: "address", label: "详细地址" }, { key: "mainProducts", label: "主营产品", type: "textarea" },
  { key: "serviceModels", label: "适配机型", type: "textarea" }, { key: "serviceAdvantages", label: "服务优势", type: "textarea" },
  ...
  { key: "processingServices", label: "加工服务", type: "textarea" }, { key: "processingMaterials", label: "加工材料 / 配件类型", type: "textarea" },
  { key: "processingEquipment", label: "加工设备", type: "textarea" }, { key: "processingCapacity", label: "加工产能 / 交期", type: "textarea" },
  { key: "processingRegions", label: "加工服务区域", type: "textarea" }, { key: "processingNotes", label: "加工接单说明", type: "textarea" },
];
...
function VendorField({ field, form, setForm }: { field: Field; form: Partial<Vendor>; setForm: (value: Partial<Vendor>) => void }) {
  ...
  if (field.type === "textarea") return <textarea value={String(value || "")} onChange={(e) => setForm({ ...form, [field.key]: e.target.value })} />;
  ...
  return <input value={String(value || "")} onChange={(e) => setForm({ ...form, [field.key]: e.target.value })} />;
}

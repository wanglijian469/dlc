...
const vendorHeaders = [
  ...
  "成立年份", "厂房面积", "员工人数", "主营产品", "服务/适配机型", "企业简介", "服务优势", "年产能/供货能力", "主要设备", "资质认证", "售后服务",
...
const vendorExample = [
  ...
  "2012", "12000平方米", "80人", "齿轮、链条、液压件", "拖拉机、收割机", "企业简介示例", "质量稳定、交付及时", "年产20万套", "数控车床、热处理设备", "ISO9001", "质保12个月",
...
const sheets = [
  ...
  },
  {
    ...
    validations: [
      { range: "V2:V2000", values: "是,否" },
      { range: "AE2:AE2000", values: "草稿,已发布,隐藏" },
      { range: "AF2:AG2000", values: "是,否" },
    ],
  },
  {
    name: "配件产品",

...
func TestCMSRoutesAreRegistered(t *testing.T) {
	...
	for _, want := range []string{
		...
		"GET /api/admin/vendor-products/duplicate-check",
		"PUT /api/admin/vendor-product-submissions/:id",
		"DELETE /api/admin/vendor-product-submissions/:id",
		"GET /api/admin/vendor-analytics",
		"GET /api/admin/product-submissions",
		"GET /api/admin/product-submissions/:id/matches",
